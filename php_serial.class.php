 ...
 *
 * @author RÃÂ©my Sanchez <thenux@gmail.com>
 * @thanks AurÃÂ©lien Derouineau for finding how to open serial ports with windows
...
class phpSerial
{
	...
	function addVars ($vars)
	{
		if ($this->_os === "linux")
		{
			$ret = $this->_exec("stty -F " . $this->_device . " " . $vars, $out);
		}
		else
		{
			$ret = $this->_exec("mode " . $this->_windevice . " PARITY=" . $vars, $out);
		}
